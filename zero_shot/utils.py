...
def parse_args():
    ...
    parser.add_argument(
        'model', type=str,
        help='For OPT model to load; pass `facebook/opt-X`.'
    )
    parser.add_argument(
        '--calib_data', type=str, choices=['wikitext2', 'ptb', 'c4'],
    ...
    parser.add_argument(
        '--act_pertoken', default=False, action='store_true',
        help='bits used for inps quantization'
    )
    parser.add_argument(
        '--actorder', default=False, action='store_true',
        help='upper and lower actorder'
    )
    parser.add_argument(
    ...
    parser.add_argument("--min", type=float, default=0.01) # smooth param
    ...
    parser.add_argument("--act_bits", type=int, default=32)
