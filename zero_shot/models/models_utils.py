...
import transformers
from .quant import SmoothAndQuantLinear

def find_layers(module, layers=[nn.Conv2d, nn.Linear, SmoothAndQuantLinear, transformers.Conv1D], name=''):
